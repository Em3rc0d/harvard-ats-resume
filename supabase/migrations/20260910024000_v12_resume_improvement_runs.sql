...
begin
  ...
  insert into public.resume_improvement_runs(
    ...
    case when p_semantic_document_json is null then null else public.cv_engine_sha256(p_semantic_document_json::text) end,
    p_editor_provenance_json,
    p_generated_document_json,
    case when p_generated_document_json is null then null else public.cv_engine_sha256(p_generated_document_json::text) end,
    p_guardian_report_json,
    case when p_guardian_report_json is null then null else public.cv_engine_sha256(p_guardian_report_json::text) end,
    p_status,
