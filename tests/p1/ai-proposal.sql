...
begin
  if not exists (
    ...
    where id=:'ai_revision_presentation_revision_id'::uuid
      ...
      and ai_provenance->>'resultSha256'=:'ai_hash_result_hash'
...
begin
  begin
    perform * from public.cv_engine_create_ai_presentation_revision(
      ...
      :'ai_strengthen_hash_strengthen_hash'
    );
