...
export function ResumeImprovementWorkspace() {
  ...
  if (result) {
    return (
      <section className="panel improvement-panel" aria-labelledby="improvement-ready-heading">
        ...
        <div className="improvement-safety" aria-label="Quality and safety summary">
        ...
        <div className="split-actions artifact-actions">
          <a className="primary link-button" href={result.downloads.docx}>Download DOCX</a>
          <a className="secondary link-button" href={result.downloads.pdf}>Download PDF</a>
        ...
        <div className="advanced-audit">
          ...
          {auditOpen ? <div className="split-actions"><a className="secondary link-button" href={result.downloads.text}>Download TXT</a><a className="secondary link-button" href={result.downloads.provenance}>Download provenance JSON</a></div> : null}
        </div>
  ...
  return (
    <section className="panel improvement-panel" aria-labelledby="improve-resume-heading">
      ...
      <div className="stack improvement-form">
        <label>
          Resume · PDF or DOCX
        ...
        <label>
          Job description <span className="optional-label">Optional — used for emphasis only, never as evidence about you</span>
      ...
      <button className="primary improve-cta" type="button" disabled={!file || busy} onClick={() => void improve()}>{busy ? "Analyzing and improving…" : "Improve my resume"}</button>
