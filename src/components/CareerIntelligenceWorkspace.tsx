...
type Surface = "EVIDENCE" | "IMPORT" | "TARGET" | "JOB" | "ASSESSMENT" | "RESUME";
  ...
  return (
    <main className="first-run-shell">
      <header className="brand-bar">
        <div><span className="brand-mark">C</span><div><strong>CV Engine</strong><span>Evidence · import · intent · market truth · assessment · trusted resume</span></div></div>
        <span className="build-label">vNext · B5</span>
      </header>
      <nav className="split-actions" aria-label="CV Engine truth, import, analysis and resume surfaces">
