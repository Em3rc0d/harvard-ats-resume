...
const SECTION_HEADINGS: Readonly<Record<ResumeSection, readonly string[]>> = {
  ...
  skills: [
    ...
    'TECH STACK', 'TECHNICAL STACK', 'STACK TECNICO', 'STACK TECNOLOGICO',
  ],
  projects: [
    'PROJECTS', 'PERSONAL PROJECTS', 'FEATURED PROJECTS',
    'PROYECTOS', 'PROYECTOS PERSONALES', 'PROYECTOS DESTACADOS',
    'OWN PRODUCTS', 'PRODUCTOS PROPIOS',
    'SELECTED ENGINEERING PROJECTS', 'PROYECTOS DE INGENIERIA SELECCIONADOS',
  ],
  certifications: [
    'CERTIFICATIONS', 'CERTIFICATES', 'CERTIFICACIONES', 'CERTIFICADOS',
    'CERTIFICATIONS AND COURSES', 'COURSES AND CERTIFICATIONS',
    'CERTIFICACIONES Y CURSOS', 'CURSOS Y CERTIFICACIONES',
  ],
